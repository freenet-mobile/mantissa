 ...
 * a rotation matrix can be done using one single line of code:</p>
 * <pre>
 ...
 * definition. Hence the class does <em>not</em> provide methods like
 ...
 * The composition operation <code>r = r<sub>1</sub> o r<sub>2</sub></code>
 * means that for each vector <code>u</code>, <code>r(u) =
 * r<sub>1</sub>(r<sub>2</sub>(u))</code>. Hence we can consider that in
 ...
 * <code>r<sub>1</sub></code> to <code>r<sub>2</sub></code> and the
 * result we get is <code>r = r<sub>1</sub> o r<sub>2</sub></code>.
...
public class Rotation
   ...
   * often wrongly tagged as Euler angles).</p>
